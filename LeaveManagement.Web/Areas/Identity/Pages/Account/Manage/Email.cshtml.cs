    ...
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Lien de confirmation pour le changement d'adresse Email envoyé. Merci de vérifier vos Emails.";
                return RedirectToPage();
            }

            StatusMessage = "Votre adresse Email est inchangée.";
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "Email de confirmation envoyé. Merci de vérifier vos Emails.";
            return RedirectToPage();
        }
    }
}
